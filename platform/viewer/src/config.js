...
export function setConfiguration(appConfig) {
  ...
  cornerstoneWADOImageLoader.configure({
    beforeSend: function(xhr) {
      ...
      xhr.setRequestHeader('Accept', 'multipart/related=image/dicom+jpx; transfer-syntax=1.2.840.10008.1.2.4.80, multipart/related=image/dicom+jpx; transfer-syntax=1.2.840.10008.1.2.4.81');
    },
