  ...
  return [
    {
      ...
      type: 'dicomWeb',
      active: true,
      wadoUriRoot: 'https://api.espressomedical.com/api/wado/' + dataset,
      qidoRoot: 'https://api.espressomedical.com/api/dicomweb/' + dataset,
...
const useServerFromUrl = (
  ...
  let exists = servers.some((element) => {element.wadoUriRoot == newServer.wadoUriRoot});
